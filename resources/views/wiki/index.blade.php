        ...
        <div class="max-w-screen-xl w-full mx-auto px-5">
            ...
            <div class="mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    {{-- WoE Guide --}}
                    <div class="group">
                        <a href="/wiki/woe" class="bg-gray-900 border border-gray-800 hover:bg-gray-800 p-6 rounded block transition-colors duration-200">
                            <div class="flex items-center mb-4">
                                <div class="w-10 h-10 bg-red-600 rounded flex items-center justify-center mr-4">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path>
                                    </svg>
                                </div>
                                <h3 class="text-lg font-semibold text-gray-100">War of Emperium</h3>
                            </div>
                            <p class="text-gray-400 text-sm leading-relaxed mb-3">
                                Learn about guild wars, castle sieges, and everything related to War of Emperium events.
                            </p>
                            <span class="text-amber-500 text-sm font-medium">Battle Guide →</span>
                        </a>
                    </div>
