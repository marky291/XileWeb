        ...
        <div class="bg-gray-900/80 rounded-xl border border-gray-800 shadow-lg overflow-hidden">
            <div class="p-6">
                ...
                <div class="text-center mb-6">
                    <h1 class="text-2xl font-bold text-white mb-1">Create Master Account</h1>
                    <p class="text-gray-400 text-sm">
                        Manage up to 6 game accounts from one place
                    </p>
                </div>
                ...
                <div class="mt-4 text-center">
                    ...
                    <a href="{{ route('login') }}" class="text-xilero-gold hover:text-amber-400 text-sm font-medium ml-1">
                        Sign in
                    </a>
                </div>
            </div>
