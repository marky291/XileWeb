...
<section class="bg-clash-bg min-h-screen pt-28 pb-16 px-4">
    <div class="max-w-screen-xl w-full mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">Welcome, {{ Str::ucfirst(auth()->user()->name) }}!</h1>
                <p class="text-gray-400">Manage your game characters and account settings.</p>
            </div>
            <div class="mt-4 sm:mt-0 flex flex-wrap gap-3">
                <a href="https://drive.google.com/file/d/1RDUNM6pWVBMVLzdMVyze5QmdNuc99zKH/view?usp=sharing"
                   target="_blank"
        ...
        {{-- Account Info Card --}}
        <div class="block-home bg-gray-900 p-6 rounded-lg mb-8">
            <h2 class="text-lg font-semibold text-gray-200 mb-4">Account Information</h2>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <p class="text-gray-500 text-xs uppercase tracking-wide">Username</p>
                    <p class="text-gray-100 font-semibold">{{ auth()->user()->userid }}</p>
                </div>
                <div>
                ...
                <div>
                    <p class="text-gray-500 text-xs uppercase tracking-wide">Account ID</p>
                    <p class="text-gray-100">{{ auth()->user()->account_id }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="block-home bg-gray-900 p-6 rounded-lg">
                    <h2 class="text-lg font-semibold text-gray-200 mb-4">Your Characters</h2>
                    <div class="space-y-3">
                        @forelse($characters as $character)
                            <button
                                wire:click="selectCharacter({{ $character->char_id }})"
                                wire:key="char-{{ $character->char_id }}"
                                class="w-full text-left border rounded-lg p-4 transition-all duration-200 {{ $selectedCharacterId === $character->char_id ? 'bg-amber-900/30 border-amber-500' : 'bg-gray-800/50 border-gray-700 hover:border-gray-500' }}"
                            >
                    ...
                    <div class="block-home bg-gray-900 p-6 rounded-lg">
                        <div class="flex items-start justify-between mb-6">
                            <div>
                                ...
                                <p class="text-amber-400">{{ $selectedChar->class_name }}</p>
