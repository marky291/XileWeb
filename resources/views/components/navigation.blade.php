        ...
        <div class="relative max-w-screen-2xl mx-auto w-full py-4 transition duration-200 lg:bg-transparent lg:py-6">
            <div class="max-w-screen-xl mx-auto px-5 flex items-center justify-between">
                ...
                <div class="flex-1 flex items-center justify-end">
                    ...
                    <a target="_blank" class="group relative inline-flex border border-rose-600 focus:outline-none hidden lg:ml-4 lg:inline-flex" href="https://drive.google.com/file/d/17xz2zF6och9RMLJKXwqGKIXYwcYA1uaa/view?usp=sharing">
                    ...
                    <button class="ml-2 relative w-10 h-10 inline-flex items-center justify-center p-2 text-white lg:hidden" aria-label="Toggle Menu" @click.prevent="navIsOpen = !navIsOpen">
                        <svg x-show="! navIsOpen" class="w-6" viewBox="0 0 28 12" fill="none" xmlns="http://www.w3.org/2000/svg" style="">
                            <line y1="1" x2="28" y2="1" stroke="currentColor" stroke-width="2"></line>
                            <line y1="11" x2="28" y2="11" stroke="currentColor" stroke-width="2"></line>
                        </svg>
                        <svg x-show="navIsOpen" class="absolute inset-0 mt-2.5 ml-2.5 w-5" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: none;">
                            <rect y="1.41406" width="2" height="24" transform="rotate(-45 0 1.41406)" fill="currentColor"></rect>
                            <rect width="2" height="24" transform="matrix(0.707107 0.707107 0.707107 -0.707107 0.192383 16.9707)" fill="currentColor"></rect>
                        </svg>
                    </button>
                </div>
            </div>
            ...
            <nav x-show="navIsOpen" x-transition.opacity="" class="fixed inset-0 w-full pt-[4.2rem] z-10 pointer-events-none" style="display: none;">
                <div class="relative h-full w-full py-8 px-5 bg-white pointer-events-auto overflow-y-auto">
                    <ul>
                        ...
                        <li class="flex sm:justify-center"><a class="group relative inline-flex border border-red-600 focus:outline-none mt-3 w-full max-w-md" href="https://drive.google.com/file/d/17xz2zF6och9RMLJKXwqGKIXYwcYA1uaa/view?usp=sharing">
