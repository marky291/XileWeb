...
return [
    ...
    'lite' => [
        ...
        [
            'name' => 'Download Lite from Mega Upload (1.70gb)',
            'link' => 'https://mega.nz/file/SOo3BKYS#UDAPIFUWNcfvxbGmQ5Dz_YpC9TqK1plNvjI2zz07zzQ',
            'bttn' => 'btn-secondary',
        ],
        [
            'name' => 'Download Lite from Mediafire (1.70gb)',
    ...
    'full' => [
        [
            'name' => 'Download Full from Google Drive (3.13gb)',
            'link' => 'https://drive.google.com/file/d/1WcxfwuFVZPSFlGgDuJWcIoejFzlyeHQh/view?usp=sharing',
            'bttn' => 'btn-primary',
        ],
        [
            'name' => 'Download Full from Mega Upload (3.13gb)',
            'link' => 'https://mega.nz/file/WGwnkCpB#_7_ZpeHoVEAQtpXu1qmhTAb5GojGa5kvW1i-Q8luQB8',
            'bttn' => 'btn-secondary',
        ],
        [
            'name' => 'Download Full from Mediafire (3.13gb)',
            'link' => 'https://www.mediafire.com/file/q9pd3wo8g6pkr16/Play.zip/file',
            'bttn' => 'btn-secondary',
        ],
    ],
