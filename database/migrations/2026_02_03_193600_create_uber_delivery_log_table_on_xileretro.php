...
{
    /**
     * Create uber_delivery_log table on XileRetro game database.
     *
    ...
    public function up(): void
    {
        ...
        Schema::connection('xileretro_main')->create('uber_delivery_log', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::connection('xileretro_main')->dropIfExists('uber_delivery_log');
    }
};
