...
use Database\Factories\XileRO\XileRO_GuildCastleFactory;
 ...
 * @property int $capturedTime
 * @property int $timesDefended
 ...
 */
class XileRO_GuildCastle extends XileRO_Model
{
    /** @use HasFactory<XileRO_GuildCastleFactory> */
    use HasFactory;

    protected static function newFactory(): XileRO_GuildCastleFactory
    {
        return XileRO_GuildCastleFactory::new();
    }
