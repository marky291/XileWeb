...
use App\Filament\Resources\XileRetroLoginResource\Pages\CreateXileRetroLogin;
...
class XileRetroLoginResource extends Resource
{
    ...
    {
        return [
            'index' => ListXileRetroLogins::route('/'),
            'create' => CreateXileRetroLogin::route('/create'),
            'edit' => EditXileRetroLogin::route('/{record}/edit'),
        ];
    }
}
